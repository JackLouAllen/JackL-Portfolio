	...
	<div class="navbar-start">
		<div class="dropdown">
			...
			<ul
				tabindex="0"
				role="menu"
				class="menu menu-sm dropdown-content bg-base-100 rounded-box z-10 mt-3 w-48 p-2 shadow"
			>
		...
		<a href="#top" class="btn btn-ghost text-lg font-semibold">JackLouAllen.info</a>
	</div>
